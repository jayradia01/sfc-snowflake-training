...
## Setup
  ...
  * Inside of this repository there is a sql scrip for setting up the environment, copy the following [code](setup-clean/00_setup.sql) and paste it in the new worksheet you just created.
